...
│
└───「 \`\`\`Caca Bot Assistan\`\`\` 」`
sendButLocation(from, `${menu}`, "*_© Caca Bot Assistan_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'BUTTON MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
        case 'store':
        reply('*STORE MENU*\nREADY jasa sewa bot BY Xynta\n Fitur:\n Gemge \n15k minat ketik .owner')
        break
case 'verify':
